...
<ul class="page-breadcrumb breadcrumb">
    ...
    <li>
        <span class="active">Update Publication</span>
    </li>
</ul>
    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
              <div class="caption font-red-sunglo">
                   ...
                   <span class="caption-subject bold"> Update Publication</span>
             </div>
            <div class="actions">
                 <div class="btn-group">
        ...
        <div class="portlet-body">
            <div class="tab-content">
                ...
                <div class="tab-pane active">
                     <?php echo $this->Form->create($pub, array('id'=>'add-form','type'=>'file')); ?>
                        <div class="row">
                            <div class="col-md-4">
