        ...
        <div class="col-md-12">
            <div class="portlet light portlet-fit bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <i class=" fa fa-file-image-o  font-purple"></i>
                                    ...
                                    <div class="cbp-item graphic">
                                        <div class="cbp-caption">
                                            <div class="cbp-caption-defaultWrap">
                                                <img src="/img/<?php echo $image['folder']['name'];?>/<?php echo $image['image'];?>" alt=""> </div>
                                            <div class="cbp-caption-activeWrap">
                                                <div class="cbp-l-caption-alignCenter">
                                                    <div class="cbp-l-caption-body">
                                                        <a href="/img/<?php echo $image['folder']['name'];?>/<?php echo $image['image'];?>" class="cbp-lightbox cbp-l-caption-buttonRight btn green uppercase btn green uppercase" data-title="<?php echo $image['name'];?>">view larger</a>
                                                        <a href="/admin/media/remove_image/<?php echo $image['id'];?>" class="btn red uppercase btn red uppercase" rel="nofollow">Delete</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="cbp-l-grid-projects-title uppercase text-center uppercase text-center"><?php echo $image['name'];?></div>
                                    </div>
                                    <?php }?>
                                </div>
                        </div>
