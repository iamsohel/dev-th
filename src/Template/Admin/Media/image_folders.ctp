 <ul class="page-breadcrumb breadcrumb">
    ...
    <li>
        <span class="active">Image Folders</span>
    </li>
</ul>
            ...
            <div class="portlet light portlet-fit bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-purple bold uppercase">Image Folders</span>
                    </div>
                    <div class="actions">
                    <div class="btn-group">
                        <a class="btn green-haze btn-outline btn-circle btn-sm" href="/admin/media/create_folder">
                ...
                <div class="portlet-body">
                    <?php echo $this->Form->create('Media', ['url' => '/admin/media/image_folders']); ?>
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-6">
                                <div class="color-demo" data-original-title="Click to view demos for this color" data-toggle="modal" data-target="#demo_modal_yellow-haze">
                                    ...
                                    <div class="mt-body-icons">
                                         <a href="/admin/media/images/<?php echo $folder['id'];?>" class="btn btn-circle btn-info btn-sm"><?php echo $folder['name'];?></a>
                                    </div>
